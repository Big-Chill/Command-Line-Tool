...
module WordModule
    class WordClass
        def initialize
            ...
            rel_words_arr = RelWords.get_related_words(@word)
            if(rel_words_arr == "404")
                return
            end
            ...
            def_arr = WordDef.get_definitions(@word)
            def_arr.each do |obj|
        ...
        def print_definition
            ...
            word_def = WordDef.get_definitions(@word)
        ...
        def display_synonyms
            rel_arr = RelWords.get_related_words(@word)
        ...
        def display_examples
            examples=WordExample.get_example(@word)
